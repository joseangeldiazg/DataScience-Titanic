...
Si entrenamos el modelo con este paso y evitamos el overfitting, usando el constructor de \textit{cross validation}, llegaremos a la puntuación de 0.82 en test. El código final de evaluación, se ha omitido de la memoria ya que no es relevante de cara al estudio pero puede encontrarse tanto en gitHub como en el script en Kaggle, el cual, puede ejecutarse en la propia plataforma de manera muy sencilla. 
